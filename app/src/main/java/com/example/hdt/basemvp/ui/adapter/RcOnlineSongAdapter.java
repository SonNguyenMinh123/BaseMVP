package com.example.hdt.basemvp.ui.adapter;
...
public class RcOnlineSongAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    private LayoutInflater mInflater;
    private List<ItemSongResponse> mOfflineSongs;
    private ISongAdapter mISongAdapter;

    public RcOnlineSongAdapter(Context context, ISongAdapter iSongAdapter) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ItemSongResponse itemSongResponse = mOfflineSongs.get(position);
        ViewHolderOfflineSong viewHolderOfflineSong = (ViewHolderOfflineSong) holder;
        viewHolderOfflineSong.txtTitle.setText(itemSongResponse.getTitle());
        viewHolderOfflineSong.txtArtist.setText(itemSongResponse.getArtist());
    }
...
//                    trả về vị trí của ItemData
    ...
    public void setmOfflineSongs(List<ItemSongResponse> offlineSongs) {
